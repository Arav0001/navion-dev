...
const float ACC_BIAS[3] = {-0.0150000006f, -0.0270000007f, 0.0350000001f};
const float ACC_SCALE_FACTOR[3][3] = {
	{0.994134426f, 0.0f, 0.0f},
	{0.0f, 0.996290207f, 0.0f},
	{0.0f, 0.0f, 0.991520762f}
};

const float GYR_BIAS[3] = {-0.0968380943f, -0.0192544218f, -0.150888011f};

const float MAG_BIAS[3] = {-45.4000015, -53.0f, 25.8000011};
const float MAG_SCALE_FACTOR[3][3] = {
	{1.079f, -0.0170000009f, -0.00200000009f},
	{-0.0170000009f, 1.19299996f, 0.0810000002f},
	{-0.00200000009f, 0.0810000002f, 1.09399998f}
};
